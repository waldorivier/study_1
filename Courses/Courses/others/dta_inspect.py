...
try :
    ...
    if 1 : 
        ...
        # colonne à conserver 
        col_keep = set(['TYPE_ECRIT','LIBF_TYCO','LIBF_TYEC','NO_CAS','NO_CATE','NOM_ELEM_PMT','GENRE_ELPA','NOM_ELEM_BAS'])

        # on supprime toutes les colonnes autres que celles à conserver

...
# qui sont suavegardées en base de données 
#-------------------------------------------------------------------------
...
def clear_raw_data():
    ...
    df_food_cl = df_food_sel.drop([col for col in df_food_cl.columns if "states" in col], axis=1)
    df_food_cl = df_food_sel.drop([col for col in df_food_cl.columns if "tags" in col], axis=1)
